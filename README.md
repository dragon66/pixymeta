...
-----------------------------------
There is currently no stable release of PIXYMETA. However you can pull the latest SNAPSHOT from the Maven snapshot repository by adding the following dependency to your pom.xml:
